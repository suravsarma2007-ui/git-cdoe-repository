...
@section('title', 'Edit Paper - eOffice')
    ...
    <div class="col-md-8 offset-md-2">
        ...
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0">{{ $paper->paper_name }} ({{ $paper->codes }})</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('paper.update', $paper) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('program_id') is-invalid @enderror" 
                            ...
                            @foreach ($programs as $program)
                                <option value="{{ $program->id }}" {{ old('program_id', $paper->program_id) == $program->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('codes') is-invalid @enderror" 
                               id="codes" name="codes" value="{{ old('codes', $paper->codes) }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('paper_name') is-invalid @enderror" 
                               id="paper_name" name="paper_name" value="{{ old('paper_name', $paper->paper_name) }}" required>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('semester') is-invalid @enderror" 
                                ...
                                @for ($i = 1; $i <= 8; $i++)
                                    <option value="{{ $i }}" {{ old('semester', $paper->semester) == $i ? 'selected' : '' }}>Semester {{ $i }}</option>
                                @endfor
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('years') is-invalid @enderror" 
                                ...
                                @for ($i = 2025; $i <= 2035; $i++)
                                    <option value="{{ $i }}" {{ old('years', $paper->years) == $i ? 'selected' : '' }}>Year {{ $i }}</option>
                                @endfor
                            </select>
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-circle"></i> Update Paper
                        </button>
