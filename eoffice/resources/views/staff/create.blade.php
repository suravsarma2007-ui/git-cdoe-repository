...
@section('title', 'Add Staff - eOffice')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('staff_type') is-invalid @enderror" 
                                ...
                                <option value="Faculty" {{ old('staff_type') === 'Faculty' ? 'selected' : '' }}>Faculty</option>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('discipline') is-invalid @enderror" 
                                   id="discipline" name="discipline" value="{{ old('discipline') }}">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('contact') is-invalid @enderror" 
                                   id="contact" name="contact" value="{{ old('contact') }}" maxlength="20">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control @error('doj') is-invalid @enderror" 
                                   id="doj" name="doj" value="{{ old('doj') }}" required>
