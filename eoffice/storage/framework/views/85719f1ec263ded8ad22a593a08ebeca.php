...
<?php $__env->startSection('title', 'Add Daily Video Record'); ?>

<?php $__env->startSection('content'); ?>

<form method="POST" action="<?php echo e(route('daily_record_video.store')); ?>">
    <?php echo csrf_field(); ?>
    ...
    <div class="mb-3">
        ...
        <select name="module_id" class="form-control" required>
            <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($module->slno); ?>">
                    <?php echo e($module->moduleNo); ?>
    ...
    <div class="mb-3">
        ...
        <select name="editor_emp_id" id="editor_emp_id" class="form-control" required>
            ...
            <?php $__currentLoopData = $editors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $editor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($editor->id); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cdoeOfficeAutomation\eoffice\resources\views/daily_record_video/create.blade.php ENDPATH**/ ?>